  ...
  return (
    <div className="container py-4 py-md-5">
      <div className="text-center mb-4 mb-md-5">
        <h1 className="display-5 display-md-4 fw-bold mb-3 mb-md-4 text-gradient">
          Simple Pricing
        </h1>
          ...
          <div className="card border-0 shadow-lg">
            <div className="card-body p-3 p-md-5">
              <div className="text-center mb-4">
                ...
                <div className="display-2 display-md-1 fw-bold text-primary mb-3">
                  5%
                </div>
                <p className="lead text-secondary">
                ...
                <div className="col-md-6">
                  <div className="card h-100 border-0 shadow-sm">
                    <div className="card-body p-3 p-md-4">
                      <h3 className="card-title h5 h4-md mb-3">
                        What's Included
                      </h3>
              ...
              <div className="text-center">
                <Link
                  ...
                  className="btn btn-primary btn-lg px-4 px-md-5"
                >
                  Express Interest
                </Link>
              </div>
